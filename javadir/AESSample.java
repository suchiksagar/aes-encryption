...
public class AESSample {
    ...
    public static void main(String[] args) {
        boolean encrypt = args[0].equals("e"); // encrypt | decrypt
        String key = System.getenv("CRY_KEY");
        if (encrypt) {
            String message = System.getenv("CRY_RAW");
            System.out.print(encrypt(key, message));
        } else {
            String message = System.getenv("CRY_MSG");
            System.out.print(decrypt(key, message));
        }
    }
